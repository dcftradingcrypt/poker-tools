    ...
    "EP": {
      ...
      "open_section": {
        ...
        "table_rows": [
          ...
          [
            "Fold",
            "all D2 / rough 8-tris / weak pat J-K"
          ]
        ],
        "range_groups": [
          {
      ...
      "versus_section": {
        "section_label": "Continue vs 3-bet",
        ...
        "table_rows": [
          ...
          [
            "Continue tris",
            "premium 7-tris: A23 / A24 / A25 / A34 / 234 / 245 / 345"
          ],
          [
            "Borderline",
            "J-high / best smooth 8-tris"
          ],
          [
            "Fold",
            "breakable Q-K / rough 8-tris / all D2"
          ]
        ],
        "range_groups": [
          {
    ...
    "MP": {
      ...
      "open_section": {
        ...
        "table_rows": [
          ...
          [
            "Fold",
            "routine 23 / A4 / 24 / most 5-high D2 / rough 8-tris"
          ]
        ],
        "range_groups": [
          {
      ...
      "versus_section": {
        ...
        "table_rows": [
          ...
          [
            "3-bet tris",
            "strong 6-low tris: A23 / A24 / A25 / A34 / A35 / 234 / 245 / 345"
          ],
          [
            "Flat exceptions",
            "a few strong 6-low tris only"
          ],
          [
            "Fold",
            "all D2 cold-calls / rough 8-tris / weak pats"
          ]
        ],
        "range_groups": [
          {
    ...
    "CO": {
      ...
      "open_section": {
        ...
        "table_rows": [
          ...
          [
            "Practical pat default",
            "usually Q-high+; weak J-Q-K are lineup dependent"
          ],
          [
            "Tri core",
            "all 8-tris"
          ...
          [
            "Conditional adds",
            "23 / A4 / 24 with good blockers"
          ],
          [
            "Fold",
            "routine 34 / A5 / 25 / 6-high+ D2 / rough 9-tris"
          ]
        ],
        "range_groups": [
          {
      ...
      "versus_section": {
        ...
        "table_rows": [
          ...
          [
            "Widen vs loose opens",
            "Q-high / better 7-tris"
          ],
          [
            "Flat exceptions",
            "a few very smooth tris"
          ],
          [
            "Fold",
            "all D2 cold-calls / bottom 8-tris / weak pats"
          ]
        ],
        "range_groups": [
          {
    ...
    "BTN": {
      ...
      "open_section": {
        ...
        "table_rows": [
          ...
          [
            "Conditional adds",
            "best 34 / A5 / 25 with strong blockers"
          ],
          [
            "Fold",
            "generic 6-high to 8-high D2 / very rough 9-tris"
          ]
        ],
        "range_groups": [
          {
      ...
      "versus_section": {
        ...
        "table_rows": [
          ...
          [
            "Fold",
            "all D2 cold-calls / rough 8-9 bottoms"
          ]
        ],
        "range_groups": [
          {
    ...
    "SB": {
      ...
      "open_section": {
        ...
        "table_rows": [
          ...
          [
            "Add more vs very weak BB",
            "25 / 35 / 45"
          ],
          [
            "Fold",
            "junk D2 beyond that / very rough tris"
          ]
        ],
        "range_groups": [
          {
      ...
      "versus_section": {
        "section_label": "SB Defense vs Open",
        ...
        "table_rows": [
          ...
          [
            "Vs EP / HJ / CO flat exceptions",
            "a few 6-low tris only"
          ],
          [
            "Vs BTN calls",
            "smooth wheel D2: A2 / A3 / 23 / A4 / 24"
          ],
          [
            "Vs BTN 3-bets",
            "all badugis / strong 7-tris / add A2 / A3 vs very loose BTN"
          ],
          [
            "Fold",
            "42 / 43 type rough D2 / face-up cold-calls"
          ]
        ],
        "range_groups": [
          {
    ...
    "BB": {
      ...
      "versus_section": {
        ...
        "table_rows": [
          [
            "Vs CO calls",
            "A2 / A3 / 23 / A4 / 24 + some 34 / A5 / 25 + profitable 7-tris"
          ],
          [
            "Vs BTN calls",
            "above + some 5-high D2"
          ],
          [
            "Vs raise + call",
            "256-type D2 / strong 7-tris / overlay continues"
          ],
          [
            "Vs EP open + call",
            "tighten to better A2 / A3 / 23 and strong 6-low tris"
          ],
          [
            "3-bets",
            "badugis / premium 6-low tris / add A2 / A3 vs very loose BTN"
          ]
        ],
        "range_groups": [
          {
