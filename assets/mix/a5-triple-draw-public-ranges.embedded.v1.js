window.__A5_TRIPLE_DRAW_PUBLIC_RANGES_V1 = {
  ...
  "scope": {
    ...
    "primary_views": ["first_in_open", "versus_open_continue"],
    "position_buttons": ["EP", "CO", "BTN", "SB", "BB"],
    "position_button_meaning": "shorthanded public-chart positions: EP/UTG-HJ, Cutoff, Button, Small Blind, and Big Blind",
    "open_positions": ["EP", "CO", "BTN", "SB"],
    "defense_only_positions": ["BB"],
    "excluded_from_first_in_open": ["BB"],
  ...
  "position_order": ["EP", "CO", "BTN", "SB", "BB"],
  "positions": {
    "EP": {
      "label": "EP / UTG-HJ",
      "first_in_open": {
        ...
        "open_table_rows": [
          ["Pat made hands", "Made 7s or better (0.8%)"],
          ["Premium one-card draws", "Four wheel cards (1.9%)"],
          ["Strong one-card sixes", "Four to a six (3.7%)"],
          ["Core two-card draws", "Three wheel cards (12.7%)"],
          ["Early-position three-card sixes", "A26-A46, 236, 246, 346 (7.6%)"]
        ],
      ...
      "versus_open": {
        ...
        "continue_table_rows": [
          ["Any opener", "Re-raise pat hands and one-card draws rather than flat-calling"],
          ["Premium two-card draws", "A23 / A24 / A34 can be value 3-bets; A23 may still mix in some cold-calls"],
          ["Weaker two-card draws", "A36-type hands can cold-call instead of 3-betting"],
          ["Raised-pot trim", "Bottom-opening examples such as 345 become much closer to folds once an early raise already exists"]
        ],
      ...
      "source_refs": ["countingouts_predraw", "cardplayer_predraw", "betmgm_basic", "wpt_rules", "kklive_players_guide_pdf"]
    },
    "CO": {
      "label": "Cutoff",
      "first_in_open": {
        ...
        "open_table_rows": [
          ["Carry-over early core", "Full EP shell remains in the range (26.7%)"],
          ["Late-position widen", "Add the broader three-to-a-six bucket; total open band rises to 31.7%"],
          ["Practical floor examples", "Haney's cutoff floor is around 356 or A47, but not as a solver-backed frequency mix"]
        ],
      ...
      "versus_open": {
        ...
        "continue_table_rows": [
          ["Vs earlier opens", "Re-raise pat hands and one-card draws to keep initiative and avoid face-up flats"],
          ["Premium two-card draws", "A23 / A24 / A34 can attack wider early opens with 3-bets"],
          ["Weaker two-card draws", "A36-type hands are reasonable cold-calls when you do continue"],
          ["Marginal open-class hands", "Hands near the open floor lose value once the pot is already raised"]
        ],
      ...
      "source_refs": ["countingouts_predraw", "cardplayer_predraw", "betmgm_basic"]
    },
    "BTN": {
      "label": "Button",
      "first_in_open": {
        ...
        "open_table_rows": [
          ["Cutoff carry-over", "Full CO shell remains in the range (31.7%)"],
          ["Button-only two-card layer", "Add A2 / A3 / A4 / 23 / 24 / 34 (10.9%)"],
          ["Practical steal floor", "456 / A57 / 357 are example button-edge opens, not exact mixed-frequency rows"]
        ],
      ...
      "versus_open": {
        ...
        "continue_table_rows": [
          ["Vs EP or CO open", "Pat hands and one-card draws still prefer 3-bets over flats"],
          ["Premium two-card draws", "A23 / A24 / A34 can pressure wider opening ranges with 3-bets"],
          ["Weaker two-card draws", "A36-type hands realize better in position and can be cold-calls"],
          ["Boundary discipline", "The weakest button steals are first to disappear once someone has already raised"]
        ],
    ...
    "SB": {
      ...
      "first_in_open": {
        ...
        "open_table_rows": [
          ["Tough-BB baseline", "Use the button open shell as the default"],
          ["Exploit widen", "Open wider only when the BB folds too much and does not reraise enough"],
          ["Why it stays tighter", "Thin draws realize poorly out of position against a competent BB"]
        ],
      ...
      "versus_open": {
        ...
        "continue_table_rows": [
          ["Default response", "Mostly raise or fold; if the hand is worth playing, 3-bet to isolate"],
          ["Vs loose late opener", "A2 can flat-call sometimes against aggressive late-position opens"],
          ["Vs tight EP open", "Fold A2 and other thin two-card draws much more often"],
          ["Against one-card draws", "A2 has only about 33% against 3456 and needs to improve early"]
        ],
      ...
      "source_refs": ["countingouts_predraw", "cardplayer_predraw"]
    },
    "BB": {
      "label": "Big Blind",
      "versus_open": {
        ...
        "continue_table_rows": [
          ["Vs late-position open", "Defend with at least the button opening range"],
          ["Vs early-position open", "Play a little tighter than the button baseline"],
          ["Vs SB steal", "Add A5 / 25 / 35 / 45 to the button range to get above 50% defense"],
          ["Re-raise rule", "Versus an SB raise, re-raise any two-card draw or better"]
        ],
      ...
      "source_refs": ["countingouts_predraw"]
    }
  },
  "source_index": {
